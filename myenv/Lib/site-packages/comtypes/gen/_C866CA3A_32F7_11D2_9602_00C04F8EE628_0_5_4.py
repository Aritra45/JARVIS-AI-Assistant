...
__all__ = [
    ...
    'STSF_FlagCreate', 'SpeechRegistryLocalMachineRoot', 'SPBO_NONE',
    'SPAR_High', 'SAFTADPCM_44kHzMono', 'DISPID_SRCEventInterests',
    'SpSharedRecognizer', 'DISPID_SPRsCount',
    'DISPID_SVSInputWordLength', 'SPRST_ACTIVE_ALWAYS',
    'DISPID_SPEAudioStreamOffset', 'DISPID_SLGetGenerationChange',
    'ISpeechGrammarRuleStateTransitions', 'SRSInactiveWithPurge',
    'UINT_PTR', 'SPPS_SuppressWord', 'SPAR_Medium',
    'DISPID_SPRs_NewEnum', 'SAFT48kHz8BitStereo', 'DISPID_SLWsItem',
    'ISpeechGrammarRuleState', 'SVP_19', 'DISPID_SDKGetBinaryValue',
    'SPAUDIOSTATE', 'SPRS_ACTIVE', 'DISPID_SpeechMemoryStream',
    'SPAS_CLOSED', 'DISPID_SRGCmdSetRuleState',
    'DISPID_SGRSAddRuleTransition', 'DISPID_SpeechPhraseReplacement',
    'ISpeechPhoneConverter', 'DISPID_SPPFirstElement', 'SBONone',
    'SRADynamic', 'eLEXTYPE_RESERVED6', 'DISPID_SVGetAudioInputs',
    'DISPID_SVGetAudioOutputs', 'DISPID_SLAddPronunciation',
    'SpeechFormatType', 'SVEAudioLevel', 'DISPID_SAFGetWaveFormatEx',
    'eLEXTYPE_RESERVED4', 'DISPID_SASNonBlockingIO', 'SRTReSent',
    'SPWORDPRONOUNCEABLE', 'Speech_Max_Pron_Length',
    'SECFIgnoreWidth', 'DISPID_SPPId', 'SpNotifyTranslator',
    'eLEXTYPE_PRIVATE16', 'SPSHORTCUTPAIRLIST', 'ISpeechObjectTokens',
    'eLEXTYPE_USER', 'DISPID_SPRuleConfidence',
    'DISPID_SRSAudioStatus', 'SPWORDTYPE', 'SpInProcRecoContext',
    'DISPID_SVEBookmark', 'SPEI_SOUND_START', 'SP_VISEME_6',
    'SVSFDefault', 'SP_VISEME_10', 'DISPID_SAEventHandle',
    'DISPID_SGRSAddWordTransition', 'SPSInterjection', 'SREBookmark',
    'ISpXMLRecoResult', 'SAFTCCITT_uLaw_8kHzStereo',
    'DISPID_SRSetPropertyString', 'SINoise',
    'DISPID_SWFEBitsPerSample', 'DISPID_SDKSetLongValue',
    'DISPID_SOTs_NewEnum', 'SPSERIALIZEDRESULT', 'SDTLexicalForm',
    'DISPID_SRCEFalseRecognition', 'DISPID_SGRs_NewEnum',
    'ISpeechXMLRecoResult', 'DISPID_SRCAudioInInterferenceStatus',
    'DISPID_SPEAudioSizeTime', 'SpeechTokenValueCLSID', 'ISpVoice',
    'DISPID_SWFEBlockAlign', 'SAFT24kHz8BitStereo', 'SPAUDIOOPTIONS',
    'DISPID_SGRSTType', 'DISPID_SVSPhonemeId', 'SpShortcut',
    'SpeechWordType', 'eLEXTYPE_PRIVATE1', 'SAFT44kHz16BitMono',
    'DISPID_SAFType', 'SPAO_NONE', 'SpeechCategoryAudioOut',
    'SPSEMANTICFORMAT', 'SpCustomStream', 'SAFT16kHz8BitMono',
    'SVEPhoneme', 'SAFT48kHz16BitMono', 'DISPID_SRStatus',
    'SpeechLoadOption', 'SAFT12kHz16BitMono', 'SVPOver',
    'ISpObjectWithToken', 'SAFT8kHz16BitStereo', 'ISpShortcut',
    'SLOStatic', 'SPEI_START_SR_STREAM', 'SPWAVEFORMATTYPE',
    'SPEI_VOICE_CHANGE', 'SPVISEMES', 'SPWT_LEXICAL_NO_SPECIAL_CHARS',
    'SAFT32kHz8BitStereo', 'SPSVerb', 'DISPID_SVSInputWordPosition',
    'DISPID_SpeechLexiconWords', 'SAFT16kHz8BitStereo',
    'DISPIDSPTSI_ActiveOffset', 'eLEXTYPE_PRIVATE18',
    'ISpeechAudioFormat', 'SpeechGrammarRuleStateTransitionType',
    'SWPKnownWordPronounceable', 'DISPID_SMSAMMHandle',
    'DISPID_SpeechRecoContext', 'ISpNotifyTranslator',
    'SPPROPERTYINFO', 'DISPID_SRDisplayUI', 'SPEI_RESERVED5',
    'SASRun', 'ISpeechObjectTokenCategory', 'SAFTADPCM_22kHzStereo',
    'SPEI_END_SR_STREAM', 'DISPID_SASetState',
    'DISPID_SRCEHypothesis', 'DISPID_SVEViseme', 'SDTPronunciation',
    'DISPID_SVGetVoices', 'SpeechRuleAttributes',
    'DISPID_SVAudioOutputStream', 'SDKLDefaultLocation',
    'SPINTERFERENCE_TOOLOUD', 'SPWF_INPUT', 'SPRST_INACTIVE',
    'SAFT16kHz16BitMono', 'DISPID_SGRSTs_NewEnum',
    'SpeechBookmarkOptions', 'DISPID_SBSWrite', 'DISPID_SGRAddState',
    'DISPID_SOTGetDescription', 'DISPID_SMSGetData',
    'DISPID_SpeechRecoResult', 'eLEXTYPE_RESERVED9',
    'ISpeechLexiconWord', 'DISPID_SRCEPropertyStringChange',
    'eLEXTYPE_RESERVED10', 'eLEXTYPE_USER_SHORTCUT', 'LONG_PTR',
    'DISPID_SGRSTsItem', 'SAFT24kHz16BitStereo', 'SP_VISEME_2',
    'SVP_20', 'SpMMAudioOut', 'DISPID_SRRecognizer',
    'DISPID_SGRsCount', 'SPWORDPRONUNCIATION', 'SGRSTTEpsilon',
    'SAFTCCITT_ALaw_44kHzStereo', 'SDTProperty', 'SpFileStream',
    'DISPID_SpeechDataKey', 'SVEPrivate', 'SRAONone',
    'DISPID_SpeechLexiconWord', 'DISPID_SOTRemove',
    'SAFTGSM610_22kHzMono', 'DISPID_SpeechGrammarRuleState',
    'SPFM_NUM_MODES', 'SLTUser', 'SPWT_PRONUNCIATION', 'SFTSREngine',
    'SSFMCreateForWrite', 'SAFTCCITT_uLaw_22kHzStereo',
    'SPCT_DICTATION', 'DISPID_SRCCreateResultFromMemory',
    'DISPID_SRCEInterference', 'DISPID_SBSRead', 'DISPID_SASState',
    'SDKLCurrentConfig', 'SAFTExtendedAudioFormat',
    'DISPID_SRGCmdLoadFromProprietaryGrammar',
    'DISPID_SPERequiredConfidence', 'eLEXTYPE_PRIVATE17',
    'STCInprocServer', 'ISpeechPhraseRules', 'SpSharedRecoContext',
    'SP_VISEME_13', 'ISpAudio', 'DISPID_SRGCmdLoadFromResource',
    'SP_VISEME_15', 'SPRST_ACTIVE', 'ISpObjectTokenCategory',
    ...
    'eLEXTYPE_PRIVATE14', 'ISpeechGrammarRules',
    'SAFTADPCM_11kHzMono', 'SPVPRI_ALERT', 'DISPID_SOTDisplayUI',
    'DISPID_SPIEnginePrivateData', 'DISPID_SRCERecognition',
    'DISPID_SDKEnumKeys', 'SpeechDiscardType', 'SPEI_RESERVED6',
    'ISpeechAudioStatus', 'SP_VISEME_21', 'SpeechLexiconType',
    'DISPID_SRRSetTextFeedback', 'SVPNormal',
    'DISPID_SRSCurrentStreamPosition', 'SAFTCCITT_uLaw_22kHzMono',
    'SpLexicon', 'DISPID_SAStatus', 'SAFTCCITT_ALaw_22kHzMono',
    'SpeechCategoryPhoneConverters', 'SP_VISEME_8',
    'DISPID_SOTCGetDataKey', 'DISPID_SPRules_NewEnum',
    'SPADAPTATIONRELEVANCE', '_SPAUDIOSTATE', 'SGDisplay',
    'SP_VISEME_1', 'STSF_CommonAppData', 'SpVoice',
    'SpeechGrammarTagUnlimitedDictation', 'DISPID_SPRText',
    'SP_VISEME_14', '_RemotableHandle', 'SPINTERFERENCE_TOOFAST',
    'DISPID_SRGIsPronounceable', 'DISPID_SGRSTransitions',
    'DISPID_SRCRetainedAudioFormat', 'DISPID_SPPConfidence',
    'SpPhoneConverter', 'SPSEMANTICERRORINFO', 'DISPID_SRGState',
    'SPAUDIOBUFFERINFO', 'DISPID_SRAllowVoiceFormatMatchingOnNextSet',
    'DISPID_SPPValue', 'eLEXTYPE_PRIVATE2', 'SAFT11kHz8BitStereo',
    'DISPID_SPPEngineConfidence', 'SVP_8', 'DISPID_SPCPhoneToId',
    'SPRST_NUM_STATES', 'DISPID_SVEStreamEnd', 'SPBO_PAUSE',
    'SPEI_PROPERTY_NUM_CHANGE', 'DISPID_SPRNumberOfElements',
    'SPEVENT', 'SVP_7', 'DISPIDSPTSI', 'SSTTDictation',
    'IInternetSecurityMgrSite', 'SPAO_RETAIN_AUDIO',
    'DISPID_SOTsCount', 'DISPID_SPPsCount', 'DISPID_SVAlertBoundary',
    'ISpRecoGrammar', 'ISpNotifySink', 'SVSFParseMask',
    'DISPID_SGRAttributes', 'SVSFlagsAsync',
    'SPRS_ACTIVE_WITH_AUTO_PAUSE',
    'ISpeechGrammarRuleStateTransition', 'eLEXTYPE_PRIVATE12',
    'SITooSlow', 'DISPID_SDKGetlongValue', 'DISPID_SDKSetStringValue',
    'DISPID_SPRFirstElement', 'SpUnCompressedLexicon',
    '__MIDL___MIDL_itf_sapi_0000_0020_0001', 'DISPID_SVEVoiceChange',
    'SPVPRIORITY', 'ISpProperties', 'SGSExclusive', 'SECFIgnoreCase',
    'DISPID_SpeechAudioStatus', 'SAFTTrueSpeech_8kHz1BitMono',
    'DISPID_SCSBaseStream', 'SpeechRecognitionType', 'SECFDefault',
    'DISPID_SRRTOffsetFromStart', 'DISPID_SABIEventBias',
    'SPEI_ADAPTATION', 'SPCONTEXTSTATE', 'DISPID_SRGSetTextSelection',
    'DISPID_SMSALineId', 'ISpStreamFormat', 'DISPID_SPIProperties',
    ...
    'SpeechVisemeFeature', 'SITooFast', 'SPEI_TTS_PRIVATE',
    'SSTTWildcard', 'SRAORetainAudio', 'SVSFIsNotXML', 'SP_VISEME_5',
    'DISPID_SVEPhoneme', 'SPEVENTSOURCEINFO',
    'SDA_One_Trailing_Space', 'DISPID_SVEStreamStart',
    'DISPID_SABIMinNotification', 'DISPID_SWFEChannels',
    'SGDSActiveUserDelimited', 'DISPID_SPEPronunciation',
    'SPSNotOverriden', 'SpeechCategoryRecoProfiles',
    'DISPID_SPPChildren', 'SDA_No_Trailing_Space',
    'DISPID_SPIEngineId', 'SPWORDPRONUNCIATIONLIST',
    'ISequentialStream', 'DISPID_SRGCommit', 'DISPID_SADefaultFormat',
    'SPSLMA', 'ISpeechDataKey', 'SECFIgnoreKanaType',
    'ISpeechPhraseInfo', 'SPAUDIOSTATUS', 'SRAImport',
    'SPVPRI_NORMAL', 'SpeechAudioFormatGUIDText',
    'DISPID_SRAudioInput', 'SPBO_AHEAD',
    'DISPID_SpeechGrammarRuleStateTransitions', 'SPDKL_CurrentUser',
    ...
    'DISPID_SABIBufferSize', 'SAFT12kHz8BitStereo', 'SDTRule',
    'SP_VISEME_7', 'SAFT22kHz16BitMono',
    'ISpPhoneticAlphabetConverter', 'SpNullPhoneConverter',
    'SPEI_PHRASE_START', 'SPCATEGORYTYPE', 'ISpeechFileStream',
    'DISPID_SDKOpenKey', 'SpeechDataKeyLocation', 'SRTEmulated',
    'DISPID_SPERetainedStreamOffset',
    'DISPID_SOTRemoveStorageFileName', 'SP_VISEME_17',
    'SPEI_PROPERTY_STRING_CHANGE', 'SVSFPersistXML',
    'DISPID_SOTCSetId', 'SVSFParseAutodetect',
    'DISPID_SpeechMMSysAudio', 'SPRECOCONTEXTSTATUS',
    'SPGRAMMARSTATE', 'SPAS_STOP', 'SpeechAllElements',
    'DISPID_SPIAudioSizeBytes', 'DISPID_SpeechPhraseInfo',
    'SSSPTRelativeToEnd', 'DISPID_SRSSupportedLanguages',
    'SAFTCCITT_ALaw_8kHzMono', 'SpStream', 'DISPID_SOTIsUISupported',
    'SPEI_FALSE_RECOGNITION', 'SPTEXTSELECTIONINFO',
    'DISPID_SRAllowAudioInputFormatChangesOnNextSet',
    'SpeechTokenContext', 'DISPID_SVSLastResult',
    'DISPID_SRGDictationSetState', 'SPEI_END_INPUT_STREAM',
    'IEnumSpObjectTokens', 'DISPID_SOTCId',
    'DISPID_SGRSTPropertyValue', 'SREStreamStart',
    'ISpeechCustomStream', 'eWORDTYPE_ADDED', 'SITooQuiet',
    'SpCompressedLexicon', 'DISPID_SVGetProfiles',
    'ISpeechMemoryStream', 'DISPID_SpeechGrammarRuleStateTransition',
    'SREPropertyStringChange', 'DISPID_SPIAudioSizeTime',
    'SINoSignal', 'DISPIDSPRG', 'DISPID_SpeechPhraseRules',
    'SRTExtendableParse', 'SGDSActive', 'DISPID_SpeechFileStream',
    'ISpeechRecoResultDispatch', 'SpMMAudioEnum',
    'DISPID_SRRAudioFormat', 'ISpRecoResult', 'SAFTGSM610_11kHzMono',
    'DISPID_SRCRequestedUIType', 'SAFT11kHz16BitStereo',
    'WAVEFORMATEX', 'ISpeechLexicon', 'DISPID_SRCEEndStream',
    'SpeechAudioState', '_ISpeechRecoContextEvents', 'ISpeechAudio',
    'SPRECOGNIZERSTATUS', 'SpeechInterference', 'SECFEmulateResult',
    'DISPID_SOTSetId', 'eLEXTYPE_PRIVATE8', 'SSFMOpenReadWrite',
    'DISPID_SRCEBookmark', 'DISPID_SLGetPronunciations',
    'SAFTGSM610_44kHzMono', 'SAFTText', 'SpeechPartOfSpeech',
    'DISPID_SRRTimes', 'DISPID_SWFESamplesPerSec', 'SGRSTTWildcard',
    'SPEI_SR_RETAINEDAUDIO', 'DISPID_SPCIdToPhone', 'SVSFNLPMask',
    'STSF_AppData', 'SRERecognition', 'DISPID_SRCBookmark',
    'SPCS_ENABLED', 'SPFM_CREATE', 'DISPID_SGRSTRule',
    'SECNormalConfidence', 'SpeechEngineConfidence',
    'SPBINARYGRAMMAR', 'DISPID_SGRsFindRule', 'SpeechRecognizerState',
    'ISpeechPhraseInfoBuilder', 'SPXRO_Alternates_SML', 'SRARoot',
    'SREStateChange', 'SpeechRecoContextState', 'eWORDTYPE_DELETED',
    'SpeechRetainedAudioOptions', 'SRTAutopause', 'SPPS_NotOverriden',
    'SPSSuppressWord', 'DISPID_SRCreateRecoContext',
    'SpeechVoiceCategoryTTSRate', 'SVESentenceBoundary',
    'ISpEventSource', 'SP_VISEME_11', 'SPPS_LMA', 'SGSDisabled',
    'SPRECOSTATE', 'DISPID_SpeechPhraseAlternate',
    'SPDKL_DefaultLocation', 'SP_VISEME_16', 'SP_VISEME_19',
    'DISPID_SGRSTWeight', 'SPSTREAMFORMATTYPE', 'ISpRecognizer',
    'DISPID_SOTCategory', 'DISPID_SRGCmdSetRuleIdState',
    'ISpeechPhraseElements', 'SPCT_COMMAND',
    'DISPID_SPIGetDisplayAttributes', 'SAFT44kHz8BitStereo',
    'DISPID_SPAPhraseInfo', 'DISPID_SGRSTText', 'SINone',
    'DISPID_SVAudioOutput', 'SPPS_Modifier', 'SpeechRecoEvents',
    'DISPID_SPRDisplayAttributes', 'ISpPhrase', 'SpObjectToken',
    'SWPUnknownWordPronounceable', 'eLEXTYPE_PRIVATE15',
    'SAFTADPCM_11kHzStereo', 'DISPID_SGRSTPropertyName', 'SPXRO_SML',
    'SpeechAudioFormatGUIDWave', 'SpeechRegistryUserRoot',
    'SVSFNLPSpeakPunc', 'DISPID_SRCERecognizerStateChange',
    'DISPID_SLWType', 'DISPID_SLPPhoneIds', 'eLEXTYPE_PRIVATE13',
    'DISPID_SOTId', 'SVP_0', 'eLEXTYPE_VENDORLEXICON',
    'DISPIDSPTSI_ActiveLength', 'STCAll', 'DISPID_SLWPronunciations',
    'DISPID_SRIsUISupported', 'DISPID_SPANumberOfElementsInResult',
    'DISPID_SVSLastStreamNumberQueued', 'DISPID_SPRsItem', 'SDTAll',
    'SPSHT_EMAIL', 'SAFTCCITT_uLaw_11kHzStereo',
    'SpeechCategoryAppLexicons', 'ISpeechBaseStream', 'SPPS_Unknown',
    'DISPID_SPRuleNumberOfElements', 'DISPID_SABufferInfo',
    'SPEI_REQUEST_UI', 'DISPID_SPERetainedSizeBytes',
    'eLEXTYPE_RESERVED8', 'SPPS_RESERVED2', 'SpeechTokenShellFolder',
    'Speech_Default_Weight', 'ISpRecoCategory',
    'DISPID_SPRuleChildren', 'ISpMMSysAudio', 'tagSPPROPERTYINFO',
    'ISpEventSink', 'SAFTCCITT_ALaw_8kHzStereo', 'SRSEDone',
    'ISpPhoneticAlphabetSelection', 'SPPS_Function', 'SPRS_INACTIVE',
    ...
    'SAFTNonStandardFormat', 'SVEBookmark', 'ISpeechPhraseProperty',
    'SpeechPropertyResourceUsage', 'SAFTGSM610_8kHzMono',
    'SVEStartInputStream', 'DISPID_SpeechPhraseProperty', 'SVP_16',
    'SPVPRI_OVER', 'ISpeechMMSysAudio', 'SAFT12kHz8BitMono',
    'SVSFParseSapi', 'SPEI_SENTENCE_BOUNDARY', 'DISPID_SMSADeviceId',
    'DISPID_SPEAudioSizeBytes', 'DISPID_SpeechPhraseProperties',
    'DISPID_SpeechPhraseRule', 'DISPID_SLWsCount',
    'ISpeechRecognizerStatus', 'SPSUnknown', 'SPEI_UNDEFINED',
    'DISPID_SRCERecognitionForOtherContext', 'SPCT_SLEEP',
    'SPRST_INACTIVE_WITH_PURGE', 'SVP_17', 'SAFT11kHz8BitMono',
    'DISPID_SPAsCount', 'SRAInterpreter', 'SPEI_MIN_TTS',
    'SGSEnabled', 'ISpRecognizer3', 'DISPID_SRCRetainedAudio',
    'DISPID_SAFGuid', 'DISPID_SPPBRestorePhraseFromMemory',
    'DISPID_SVEEnginePrivate', 'SpeechStreamSeekPositionType',
    'DISPID_SVSVisemeId', 'SPSFunction', 'DISPID_SPEActualConfidence',
    'SGLexicalNoSpecialChars', 'eLEXTYPE_PRIVATE4',
    'DISPID_SLWs_NewEnum', 'SPWF_SRENGINE', 'DISPID_SVRate',
    'SRERecoOtherContext', 'SpeechAudioFormatType',
    'DISPID_SRIsShared', 'Speech_StreamPos_Asap', 'DISPID_SFSClose',
    'SSFMCreate', 'DISPIDSPTSI_SelectionOffset',
    'DISPID_SRGetPropertyString', 'STCLocalServer', 'SP_VISEME_9',
    'SAFTADPCM_44kHzStereo', 'DISPID_SPRuleFirstElement',
    'STSF_LocalAppData', 'SREHypothesis', 'SpeechTokenIdUserLexicon',
    'SPAR_Unknown', 'DISPID_SpeechRecognizer', 'SREAdaptation',
    'SPSNoun', 'SPCT_SUB_DICTATION', 'eLEXTYPE_PRIVATE3', 'SVP_1',
    'SVSFPurgeBeforeSpeak', 'ISpeechRecoGrammar', 'SP_VISEME_12',
    'DISPID_SRGId', 'SP_VISEME_0', 'SPWP_KNOWN_WORD_PRONOUNCEABLE',
    'SPAR_Low', 'SRESoundStart', 'DISPID_SPIRetainedSizeBytes',
    'SLTApp', 'DISPID_SPRuleId', 'DISPID_SPEAudioTimeOffset',
    'SSTTTextBuffer', 'SREAudioLevel', 'ISpeechWaveFormatEx',
    'SPSHT_Unknown', 'SPWT_DISPLAY', 'DISPID_SpeechVoiceEvent',
    'SVF_Stressed', 'SVP_13', 'eLEXTYPE_PRIVATE6',
    'SPSHT_NotOverriden', 'DISPID_SPACommit',
    'SPINTERFERENCE_LATENCY_WARNING', 'DISPID_SRSClsidEngine',
    'SPEI_RECOGNITION', 'eLEXTYPE_PRIVATE7', 'STCRemoteServer',
    'DISPID_SpeechPhraseElement', 'DISPID_SVSRunningState', 'SPWORD',
    'SDTDisplayText', 'SVPAlert', 'SPWORDLIST', 'SPBOOKMARKOPTIONS',
    'DISPID_SRCVoicePurgeEvent', 'SPRECORESULTTIMES', 'SPGS_DISABLED',
    'SPEI_SR_PRIVATE', 'SPLO_DYNAMIC', 'DISPID_SRRGetXMLResult',
    'SDKLCurrentUser', 'DISPID_SRCState', 'SDTAlternates',
    'ISpNotifySource', 'eLEXTYPE_PRIVATE19',
    'DISPID_SRRGetXMLErrorInfo', 'SAFT8kHz8BitMono',
    'DISPID_SWFEFormatTag', 'DISPID_SAVolume', 'SAFT8kHz16BitMono',
    'DISPID_SPIRule', 'DISPID_SpeechObjectToken',
    'DISPID_SRGSetWordSequenceData', 'DISPID_SBSSeek',
    'DISPID_SLPLangId', 'SPSMF_SRGS_SEMANTICINTERPRETATION_W3C',
    'DISPID_SpeechPhraseReplacements', 'DISPID_SPEs_NewEnum',
    'DISPID_SPPsItem', 'DISPID_SMSSetData',
    'SPRS_ACTIVE_USER_DELIMITED', 'SVF_Emphasis',
    'DISPID_SVWaitUntilDone', 'SPFM_OPEN_READONLY',
    'SWPUnknownWordUnpronounceable', 'SRSEIsSpeaking',
    'SECFNoSpecialChars', 'DISPID_SpeechAudioBufferInfo',
    'SRSInactive', 'DISPID_SRCERequestUI', 'SREPrivate',
    'DISPID_SDKDeleteKey', 'DISPID_SABufferNotifySize', 'SPEI_MIN_SR',
    'SVSFVoiceMask', 'SpeechTokenKeyUI', 'SpeechEngineProperties',
    'DISPID_SVPause', 'SpeechWordPronounceable',
    'SAFTCCITT_uLaw_8kHzMono', 'SP_VISEME_18', 'SLODynamic',
    'SAFT12kHz16BitStereo', 'SRSActive', 'SVP_18',
    'ISpeechLexiconPronunciations', 'SRESoundEnd',
    'DISPID_SWFEAvgBytesPerSec', 'SpMMAudioIn', 'SPCS_DISABLED',
    'SPLO_STATIC', 'DISPID_SRSetPropertyNumber', 'SASStop',
    'DISPID_SRCEAudioLevel', 'SRAExport', 'SPLOADOPTIONS',
    'SREPropertyNumChange', 'DISPID_SRGCmdLoadFromFile',
    'SPINTERFERENCE_NOISE', 'SPINTERFERENCE_TOOSLOW',
    'SpeechVoiceEvents', 'DISPID_SVIsUISupported',
    'DISPID_SpeechLexiconPronunciation',
    'DISPIDSPTSI_SelectionLength', 'DISPID_SRRRecoContext',
    'ISpeechRecoResult', 'ISpRecognizer2', 'DISPID_SPELexicalForm',
    'SRCS_Disabled', 'SDKLLocalMachine', 'SPEI_MAX_TTS',
    'DISPID_SRGDictationUnload', 'SPEI_MAX_SR', 'DISPID_SGRSRule',
    ...
    'SPSMF_UPS', 'SRERequestUI', 'DISPID_SpeechPhraseAlternates',
    'DISPID_SPEDisplayText', 'SVEWordBoundary', 'SPPHRASERULE',
    'DISPID_SOTDataKey', 'DISPID_SLWWord',
    'SAFTCCITT_ALaw_22kHzStereo', 'SAFT16kHz16BitStereo',
    'DISPID_SVEWord', 'DISPID_SGRName', 'SAFT44kHz8BitMono',
    'SPPHRASEPROPERTY', 'DISPID_SOTMatchesAttributes',
    'DISPID_SLPPartOfSpeech', 'SAFTCCITT_ALaw_11kHzStereo',
    'SPPHRASEREPLACEMENT', 'SPEI_SR_BOOKMARK', 'SPGRAMMARWORDTYPE',
    'SWTAdded', 'SPEI_ACTIVE_CATEGORY_CHANGED', 'eLEXTYPE_PRIVATE20',
    'eLEXTYPE_RESERVED7', 'SpMemoryStream', 'SpeechRunState',
    'SpStreamFormatConverter', 'SRTSMLTimeout',
    'DISPID_SVSLastBookmarkId', 'SAFTNoAssignedFormat',
    'ISpeechPhraseAlternate', 'DISPID_SGRId', 'SpWaveFormatEx',
    'DISPID_SRRSpeakAudio', 'SpeechPropertyAdaptationOn',
    'SPLEXICONTYPE', 'DISPID_SRCSetAdaptationData',
    'ISpeechPhraseRule', 'DISPID_SpeechPhraseElements',
    'ISpeechRecoResult2', 'SPPS_RESERVED1', 'SpeechRuleState',
    'SPPS_Verb', 'SAFT22kHz8BitStereo', 'SPPS_Interjection', 'SVP_14',
    'DISPID_SOTCreateInstance', 'SGDSInactive', 'SREStreamEnd',
    'DISPID_SPIGrammarId', 'Speech_Max_Word_Length',
    'DISPID_SRGetPropertyNumber', 'SGRSTTWord', 'SPEI_VISEME',
    'SPPS_RESERVED4', 'SAFTADPCM_8kHzStereo',
    'DISPID_SDKSetBinaryValue', 'SPXMLRESULTOPTIONS', 'SGRSTTRule',
    'SPPS_Noncontent', 'DISPID_SLPSymbolic',
    'DISPID_SVSInputSentencePosition', 'DISPID_SRRPhraseInfo',
    'SDA_Two_Trailing_Spaces', 'DISPID_SLRemovePronunciation',
    'SAFT48kHz8BitMono', 'DISPID_SRGRules', 'SPEI_SOUND_END',
    'DISPID_SLPsItem', 'DISPID_SBSFormat',
    'SpeechCategoryRecognizers', 'ISpRecoGrammar2',
    'DISPID_SpeechVoiceStatus', 'DISPID_SPRuleEngineConfidence',
    'SPFILEMODE', 'SpeechDisplayAttributes', 'SAFT22kHz8BitMono',
    'SpeechVoiceSpeakFlags', 'SPEI_START_INPUT_STREAM',
    'DISPID_SRCResume', 'DISPID_SRRTStreamTime',
    ...
    'DISPID_SpeechRecoResultTimes', 'DISPID_SpeechGrammarRules',
    'eLEXTYPE_PRIVATE5', 'DISPID_SLGetWords', 'DISPID_SVSkip',
    'ISpPhoneConverter', 'SpeechGrammarTagWildcard',
    ...
    'DISPID_SRSCurrentStreamNumber', 'SPCT_SUB_COMMAND',
    'DISPID_SOTGetAttribute', 'SpPhoneticAlphabetConverter',
    'DISPID_SLPsCount', 'SP_VISEME_4', 'SPDKL_CurrentConfig',
    'DISPID_SRRSaveToMemory', 'DISPID_SRRTLength', 'SPPS_RESERVED3',
    'SAFTDefault', 'ISpObjectToken', 'ISpeechLexiconWords',
    'ISpStream', 'SPSMF_SRGS_SAPIPROPERTIES',
    'DISPID_SASCurrentDevicePosition', 'SpObjectTokenCategory',
    'SASClosed', 'DISPID_SPRuleName', 'SRSActiveAlways',
    'DISPID_SRCRecognizer', 'DISPID_SGRInitialState', 'IStream',
    'SPWP_UNKNOWN_WORD_UNPRONOUNCEABLE', 'ISpeechPhraseReplacements',
    'SPEI_RESERVED2', 'SPAS_RUN', 'SPPS_Noun',
    'eLEXTYPE_LETTERTOSOUND', 'SGRSTTTextBuffer', 'ISpRecoContext',
    'SPSMF_SAPI_PROPERTIES', 'SPSModifier', 'SRCS_Enabled',
    'SpeechPropertyResponseSpeed', 'SECHighConfidence',
    'DISPID_SOTGetStorageFileName', 'DISPID_SDKEnumValues',
    'DISPID_SOTsItem', 'DISPID_SVSLastBookmark', 'SPDKL_LocalMachine',
    'SWTDeleted', 'DISPID_SpeechPhraseBuilder',
    'SpeechAudioProperties', 'SAFT32kHz8BitMono',
    'DISPID_SDKCreateKey', 'SPINTERFERENCE', 'eLEXTYPE_PRIVATE11',
    'DISPID_SRRTTickCount', 'DISPID_SpeechAudio', 'SVSFUnusedFlags',
    'DISPID_SpeechLexicon', 'ISpResourceManager', 'eLEXTYPE_PRIVATE9',
    'SVP_11', 'DISPID_SpeechObjectTokens', 'SVSFParseSsml',
    'SREFalseRecognition', 'ISpeechRecognizer', 'SREPhraseStart',
    'SPINTERFERENCE_LATENCY_TRUNCATE_BEGIN', 'SDTAudio',
    'SAFT24kHz8BitMono', 'DISPID_SRGCmdLoadFromObject',
    'DISPID_SGRsAdd', 'SPPHRASE', 'SPEVENTENUM', 'DISPID_SPIGetText',
    'DISPID_SFSOpen', 'SPEI_RESERVED3', 'SSFMOpenForRead',
    'SpeechVisemeType', 'SPWT_LEXICAL', 'DISPID_SGRsDynamic',
    'DISPID_SpeechPhoneConverter', 'Speech_StreamPos_RealTime',
    'SPINTERFERENCE_TOOQUIET', 'SpResourceManager',
    ...
    'DISPID_SpeechWaveFormatEx', 'DISPID_SDKDeleteValue',
    'DISPID_SRCEStartStream', 'SAFT32kHz16BitMono',
    'SRADefaultToActive', 'DISPID_SGRsCommitAndSave',
    'DISPID_SVVoice', 'SPRULESTATE', 'SPDATAKEYLOCATION',
    'DISPID_SVSInputSentenceLength',
    'SpeechPropertyHighConfidenceThreshold', 'ISpeechRecoResultTimes',
    'DISPID_SASFreeBufferSpace', 'DISPID_SPAs_NewEnum',
    'SpeechAddRemoveWord', 'SSSPTRelativeToStart', 'ISpPhraseAlt',
    ...
    'DISPID_SPIElements', 'DISPID_SRCESoundEnd', 'SVP_21',
    'tagSPTEXTSELECTIONINFO', 'DISPID_SpeechCustomStream',
    'DISPID_SLGenerationId', 'DISPID_SRGetRecognizers',
    '_ISpeechVoiceEvents', 'DISPID_SGRClear',
    'SpeechPropertyComplexResponseSpeed', 'DISPID_SVEAudioLevel',
    'DISPID_SPISaveToMemory', 'IEnumString', 'DISPID_SRCVoice',
    'ISpLexicon', 'DISPID_SPEsItem', 'SVP_4',
    'DISPID_SRRDiscardResultInfo', 'DISPID_SVSCurrentStreamNumber',
    'SpeechPropertyNormalConfidenceThreshold',
    'DISPID_SPEDisplayAttributes', 'SFTInput', 'SREInterference',
    'SAFTCCITT_uLaw_44kHzMono', 'SpeechAudioVolume',
    'SPEI_INTERFERENCE', 'SPEI_SR_AUDIO_LEVEL', 'SVSFIsFilename',
    'SVP_9', '__MIDL___MIDL_itf_sapi_0000_0020_0002', 'SVP_2',
    ...
    'DISPID_SGRAddResource', 'DISPID_SGRSTPropertyId',
    'SpAudioFormat', 'SpeechTokenKeyFiles', 'SASPause',
    'SDTReplacement', 'SPEI_WORD_BOUNDARY', 'SAFTADPCM_22kHzMono',
    'DISPID_SVESentenceBoundary', 'SVEEndInputStream',
    'DISPID_SRGReset', 'ISpDataKey', 'DISPID_SpeechBaseStream',
    'SPEI_RECO_OTHER_CONTEXT', 'DISPID_SRGRecoContext', 'SVSFIsXML',
    'DISPID_SVSyncronousSpeakTimeout', 'SpTextSelectionInformation',
    'ISpeechObjectToken', 'tagSTATSTG', 'SPEI_HYPOTHESIS',
    'SGRSTTDictation', 'SPAS_PAUSE', 'DISPID_SGRSTNextState',
    'SITooLoud', 'SPBO_TIME_UNITS', 'ISpSerializeState',
    'SPSHT_OTHER', 'ISpeechResourceLoader', 'DISPID_SPEsCount',
    'SVP_5', 'DISPID_SAFSetWaveFormatEx', 'SpeechVoicePriority',
    'SAFT8kHz8BitStereo', 'DISPID_SpeechRecognizerStatus',
    'DISPID_SPRulesItem', 'SPPHRASEELEMENT', 'SP_VISEME_20',
    'eLEXTYPE_PRIVATE10', 'SVEVoiceChange',
    'IInternetSecurityManager', 'DISPID_SpeechRecoResult2',
    'SGPronounciation', 'SPEI_RESERVED1', 'SPEI_TTS_BOOKMARK',
    'DISPID_SRGDictationLoad', 'eLEXTYPE_APP', 'SREAllEvents',
    'ISpeechVoice', 'DISPID_SLPType', 'SPFM_OPEN_READWRITE',
    'SPSMF_SRGS_SEMANTICINTERPRETATION_MS', 'SGLexical',
    'SVEAllEvents', 'DISPID_SREmulateRecognition', 'SVP_6',
    'DISPID_SRCEPropertyNumberChange', 'ISpeechPhraseReplacement',
    'DISPID_SVAllowAudioOuputFormatChangesOnNextSet',
    'ISpeechRecoContext', 'SpeechUserTraining',
    'SAFT32kHz16BitStereo', 'SAFT24kHz16BitMono',
    'SpeechGrammarState', 'SVP_15', 'DISPID_SASCurrentSeekPosition',
    'DISPID_SRRAudio', 'SpeechGrammarWordType',
    'SpeechStreamFileMode', 'SPWP_UNKNOWN_WORD_PRONOUNCEABLE',
    'ISpeechGrammarRule', 'SAFT11kHz16BitMono', 'DISPID_SPRuleParent',
    'SPGS_EXCLUSIVE', 'STCInprocHandler', 'SBOPause',
    'SAFTADPCM_8kHzMono', 'DISPID_SPAsItem', 'DISPID_SRState',
    'DISPID_SGRSTsCount', 'SPGS_ENABLED',
    'SSSPTRelativeToCurrentPosition', 'DISPID_SRGetFormat',
    'SpeechMicTraining', 'DISPID_SpeechAudioFormat', 'SVF_None',
    'SVP_10', 'DISPID_SVResume', 'ISpeechPhraseElement',
    'SpeechTokenKeyAttributes', 'SPEI_RECO_STATE_CHANGE',
    'SPPARTOFSPEECH', 'DISPID_SVEventInterests', 'DISPID_SRCPause',
    'DISPID_SPPParent', 'DISPID_SPIStartTime', 'SRATopLevel',
    'DISPID_SLAddPronunciationByPhoneIds', 'DISPID_SPPName',
    'DISPID_SVStatus', 'DISPID_SPARecoResult', 'DISPID_SGRsItem',
    'ISpStreamFormatConverter', 'DISPID_SRCEAdaptation',
    'DISPID_SDKGetStringValue', 'SAFT48kHz16BitStereo',
    'SECLowConfidence', 'DISPID_SRCESoundStart', 'SVP_3',
    'DISPID_SVSpeakCompleteEvent', 'DISPID_SLWLangId',
    'SPFM_CREATE_ALWAYS', 'DISPID_SVVolume', 'DISPID_SLPs_NewEnum',
    'ISpRecoContext2', 'DISPID_SRRAlternates', 'DISPID_SVPriority'
]

_check_version('1.2.0', 1690113683.938555)
